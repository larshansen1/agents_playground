...
class TestCostFieldPersistence:
    ...
    async def test_task_created_with_cost_fields_null(self, async_session: AsyncSession, sample_task_data):
    ...
    async def test_task_cost_fields_persistence(self, async_session: AsyncSession, sample_task_data):
...
class TestCostAggregationEndpoints:
    ...
    async def test_cost_by_user_multiple_tasks(self, client: AsyncClient, async_session: AsyncSession):
    ...
    async def test_cost_by_user_ignores_null_costs(self, client: AsyncClient, async_session: AsyncSession):
...
class TestCostFieldsInTaskResponse:
    ...
    async def test_get_task_includes_cost_fields(self, client: AsyncClient, async_session: AsyncSession):
    ...
    async def test_list_tasks_includes_cost_fields(self, client: AsyncClient, async_session: AsyncSession):
...
class TestCostTrackingEndToEnd:
    ...
    async def test_multiple_users_cost_isolation(self, client: AsyncClient, async_session: AsyncSession):
